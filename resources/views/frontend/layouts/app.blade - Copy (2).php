    ...
    <div class="agileits_header">
        ...
        <div class="w3l_search">
            <form action="{{url('/products')}}" method="get">
                <input type="text" name="q" placeholder="Search a product..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search a product...';}" required="">
    ...
    <div class="logo_products">
        <div class="container">
            <div class="w3ls_logo_products_left">
                <h1><a href={{route('frontend.index')}}><span>Lara</span> Shop</a></h1>
            </div>
